    ...
    <ThemeProvider>
      <div className="min-h-screen bg-gradient-to-br from-purple-500 to-pink-500 dark:from-purple-900 dark:to-pink-900 flex items-center justify-center p-4">
        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white/10 backdrop-blur-lg dark:bg-black/20 rounded-xl p-6 shadow-xl">
          ...
          {((isPlaying && selectedGame === 'hangver') || (players.length > 0 && !selectedGame)) && (
            <button
              ...
              className="mt-4 w-full px-4 py-2 bg-red-500 dark:bg-red-700 text-white rounded-lg hover:bg-red-600 dark:hover:bg-red-800 transition-colors"
            >
              End Game
            </button>
          )}
